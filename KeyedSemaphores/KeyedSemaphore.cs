...
namespace KeyedSemaphores
{
    ...
    {
        private static readonly KeyedSemaphoresDictionary<string> Dictionary =
            new KeyedSemaphoresDictionary<string>();

        /// <inheritdoc cref="IKeyedSemaphoresCollection{TKey}.LockAsync" />
        public static ValueTask<IDisposable> LockAsync(
            string key,
        ...
        public static ValueTask<bool> TryLockAsync(
            string key,
            TimeSpan timeout,
            Action callback,
            CancellationToken cancellationToken = default
        ...
        public static async ValueTask<IDisposable?> TryLockAsync(
            string key,
            TimeSpan timeout,
            CancellationToken cancellationToken = default
        )
